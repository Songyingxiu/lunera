...
<body class="bg-gradient-to-br from-[#0f0c29] via-[#302b63] to-[#24243e] font-body text-white overflow-x-hidden selection:bg-primary selection:text-black">
        ...
        <div class="absolute bottom-0 left-0 w-full px-5 md:px-12 pb-6 md:pb-10 z-10 max-w-[1200px] mx-auto left-1/2 -translate-x-1/2 flex flex-col md:flex-row items-end gap-5 md:gap-7">
            ...
            <div class="flex-1 w-full max-w-3xl">
                ...
                <div class="flex items-center gap-3 w-full md:w-auto">
                    ...
                    <button class="w-10 h-10 md:w-11 md:h-11 bg-surface-dark/80 border border-cyber-purple text-cyber-purple rounded-md flex items-center justify-center hover:bg-cyber-purple/20 hover:text-white shadow-[0_0_10px_rgba(188,19,254,0.3)] hover:shadow-neon-purple transition-all backdrop-blur-sm">
                        <span class="material-symbols-outlined text-base md:text-lg">bookmark_add</span>
                    </button>
                </div>
            </div>
        </div>
    ...
    <script>
        function showAllEpisodes() {
            // Ambil semua elemen dengan class 'extra-episode'
            const extraEps = document.querySelectorAll('.extra-episode');
            
            // Hilangkan class 'hidden' dan tambahkan animasi
            extraEps.forEach(ep => {
                ep.classList.remove('hidden');
                ep.classList.add('animate-fade-in');
            });
            
            // Sembunyikan tombol Show More setelah ditekan
