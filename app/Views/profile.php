...
<title>Lunera Cyberpunk Profile v2</title>
...
<span class="material-symbols-outlined text-secondary" style="font-size: 28px; text-shadow: 0 0 8px #00f0ff;">bolt</span>
<h1 class="text-xl font-black tracking-tight text-white uppercase italic text-glow-purple">Lunera</h1>
</div>
<button class="flex items-center justify-center w-10 h-10 text-white rounded-full bg-surface-dark hover:bg-surface-dark border border-white/10 hover:border-secondary/50 shadow-lg hover:shadow-neon-cyan transition-all duration-300">
...
<h2 class="font-cyber text-3xl font-bold tracking-wider text-white drop-shadow-[0_0_10px_rgba(255,255,255,0.5)]">NEO_GHOST</h2>
...
<img class="w-full h-full object-cover opacity-60 group-hover:opacity-100 transition-opacity duration-500" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDzZfpDVCpxDZoQX4Ved_PJm8CimT7q9V5W25F3Y5rrmpF4ez-P40ZQIRCgRb1OtY6e8TEli8fbI0ZoVtRZYim__E1aacRlyNPOc6AnN3B3bVv1Sq3LSiHT7i0CmEMEJrios8dCPr3HILAJehzJWSLevaO-_Tuhn-Qs47khAaBg3yQ-sk1ztCkAMJc5i69LLq7raoi0sbI_LwoZt0Eh5xog5iQlSb8kJyQA4iwEmSlr8V9zPLCeEB0D26rjyh4hLT1S5zQqFGrNtz9D"/>
<div class="absolute inset-0 bg-gradient-to-t from-black/90 via-transparent to-transparent"></div>
<div class="absolute bottom-2 left-3">
<span class="text-xs font-bold text-white font-cyber">Chainsaw Man</span>
</div>
</div>
</div>
<div class="relative group cursor-pointer overflow-hidden rounded-sm border border-white/5 hover:border-tertiary/50 transition-all">
<div class="aspect-video bg-surface-dark relative">
<img class="w-full h-full object-cover opacity-60 group-hover:opacity-100 transition-opacity duration-500" src="https://lh3.googleusercontent.com/aida-public/AB6AXuB0YAX2IzJnEB5Bi702qX7Rc5mLAa0XA6dGJHi6nP8wZZdsKFSR6rkoablOYYCaMkm0F0rRV6RrxMrf9pv0btaTBImQmWoyjofrHJ6fblKWgJOZX3zzghlbSULAIcTLk2UwiKOiiOSZS4ORLtU8CBhsg0IkUss-gdPksO2e83yyVtcKSfEiFmXQpfin21pjrzw1ilwddra3rH0zyWLz3v_EVsFTOp5pEQ01lMJj6dmoIuQmtx5Fu0l3fzGLE2VCpkXGplMLQ47M2xVd"/>
<div class="absolute inset-0 bg-gradient-to-t from-black/90 via-transparent to-transparent"></div>
<div class="absolute bottom-2 left-3">
<span class="text-xs font-bold text-white font-cyber">Spy x Family</span>
</div>
</div>
</div>
</div>
